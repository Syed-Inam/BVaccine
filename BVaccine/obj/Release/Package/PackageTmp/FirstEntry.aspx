<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="FirstEntry.aspx.cs" Inherits="BVaccine.WebForm2" Culture="en-GB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function proof(id) {
            ...
            if (val != "" && (val < 1 || val > 3)) {
                alert('Invalid input value! This field only takes 1, 2, 3 as input.');
        ...
        function statusinput(id) {
            var val = document.getElementById(id).value;
            if (val != "" && (val < 1 || val > 5)) {
                alert('Invalid input value! This field takes only 1 to 5 as input.');
                document.getElementById(id).value = "";
            }
        }
        ...
        function language(id) {
            var val = document.getElementById(id).value;
            if (val != "" && (val < 1 || val > 14)) {
                alert('Invalid input value! This field takes only 1 to 14 as input.');
                document.getElementById(id).value = "";
            }
        }
        ...
        function input(id) {
            var val = document.getElementById(id).value;
            if (val != "" && !(val == 1 || val == 2)) {
                alert('Invalid input value! This field takes only 1 or 2 as input.');
                document.getElementById(id).value = "";
            }
        }
        ...
        function CalculateAge() {
            ...
            document.getElementById("txtAge").value = monleft;
        ...
        <table border="1" style="text-align: center; width: 100%; margin-top: 20px; background-color: #808080; border: 1px solid #BFBFBF; color: #2C3E50; font-family: Tahoma;">
            ...
            <tr style="height: 60px; font-family: Calibri; font-size: 19px; color: white; ">
                ...
                <td style="text-align: left; padding-left: 15px">
                    <asp:TextBox ID="txtDSSID" runat="server" Height="31px" placeholder="dssid" ForeColor="Black" CssClass="auto-style2" OnTextChanged="txtDSSID_TextChanged1" AutoPostBack="true"></asp:TextBox>
                    <cc1:MaskedEditExtender ID="MaskedEditExtender21" runat="server" Mask="LL/LL/99/999/L/9" MaskType="None" TargetControlID="txtDSSID" ClearMaskOnLostFocus="false"/>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtStudyID" ErrorMessage="*Required Field is empty" Font-Size="Smaller" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
                <td style="font-weight: 600" class="auto-style2">Study ID</td>
                <td style="text-align: left; padding-left: 15px">
                    <asp:TextBox ID="txtStudyID" Width="150px" placeholder="case id" Height="31px" runat="server" MaxLength="5" type="number" ForeColor="Black" CssClass="auto-style2"></asp:TextBox>
                    <span class="auto-style2">-</span>
                    <asp:TextBox ID="txtChildID" Width="40px" placeholder="id" runat="server" Height="31px" MaxLength="1" type="number" ForeColor="Black" CssClass="auto-style2"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtStudyID" ErrorMessage="*Required Field is empty" Font-Size="Smaller" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
        </table>
            ...
            <table id="tbl1" class="table table-hover table-responsive" style="text-align: left; width: 100%; font-size: medium; background-color: #DDDDDD; font-family: Tahoma;">
                ...
                <tr class="thStyle">
                    ...
                    <td class="tdStyle tdText">
                        <asp:TextBox ID="txtName" runat="server" CssClass="auto-style2" placeholder="name" Width="200"></asp:TextBox>
                    ...
                    <td class="tdStyle tdText">
                        <asp:TextBox ID="txtICode" Width="100px" runat="server" CssClass="auto-style2" placeholder="code" MaxLength="4"></asp:TextBox>
            ...
            <table id="tblQ5" runat="server" class="table table-hover" style="text-align: left; width: 100%; margin-top: 20px; font-size: 16px; background-color: #DDDDDD; font-family: Tahoma;">
                <tr class="thStyle" runat="server">
                    ...
                    <td colspan="3" class="tdStyle" runat="server">
                        <asp:TextBox ID="txtGender" runat="server" onkeyup="input('txtGender')" ClientIDMode="Static" MaxLength="1" CssClass="txtbxRd" placeholder="1 / 2" Width="150px"></asp:TextBox></td>
                </tr>
                <tr class="thStyle">
                    ...
                    <td class="tdStyle tdText">
                        <asp:TextBox ID="txtAge" Width="100px" runat="server" ClientIDMode="Static" CssClass="auto-style2" MaxLength="2" placeholder="months"></asp:TextBox></td>
                </tr>
                <tr class="thStyle">
                ...
                <table id="tblQ10" runat="server" class="table table-hover" style="text-align: left; width: 100%; margin-top: 20px; font-size: 16px; background-color: #DDDDDD; font-family: Tahoma;">
                    <tr class="thStyle">
                        ...
                        <td class="tdStyle tdText">
                            <asp:TextBox ID="txtQ10" runat="server" placeholder="??" CssClass="auto-style2" MaxLength="10" Width="140px"></asp:TextBox></td>
                        <td class="tdStyle tdText">
                    ...
                    <tr class="thStyle">
                        ...
                        <td class="tdStyle tdText">
                            <asp:TextBox ID="txtQ12" runat="server" placeholder="??" CssClass="auto-style2" MaxLength="10" Width="140px"></asp:TextBox></td>
                        <td class="tdStyle tdText">
                    ...
                    <div id="tbl2" runat="server">
                        ...
                        <table class="table table-hover" style="text-align: left; width: 100%; margin-top: 20px; font-size: 16px; background-color: #DDDDDD; font-family: Tahoma;">
                            ...
                            <tr class="thStyle">
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtimbcg" runat="server" onkeyup="input('txtimbcg')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtimbcg_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtimbcg_src" runat="server" placeholder="code" CssClass="auto-style2" MaxLength="2" Width="125px"></asp:TextBox></td>
                            </tr>
                            <tr class="thStyle">
                                <td colspan="1" class="auto-style3">OPV0 (Oral drops)</td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtopv0" runat="server" onkeyup="input('txtopv0')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtopv0_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtopv0_src" runat="server" placeholder="code" MaxLength="2" CssClass="auto-style2" Width="125px"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr class="thStyle">
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtopv1" runat="server" onkeyup="input('txtopv1')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtopv1_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtopv1_src" runat="server" placeholder="code" CssClass="auto-style2" MaxLength="2" Width="125px"></asp:TextBox></td>
                            </tr>
                            <tr class="thStyle">
                                <td colspan="1" class="auto-style3">Penta1 (Right thigh)</td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtp1" runat="server" onkeyup="input('txtp1')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtp1_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtp1_src" runat="server" placeholder="code" CssClass="auto-style2" MaxLength="2" Width="125px"></asp:TextBox></td>
                            </tr>
                            <tr class="thStyle">
                                <td colspan="1" class="auto-style3">PCV1 (Left thigh)</td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtpcv1" runat="server" onkeyup="input('txtpcv1')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtpcv1_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtpcv1_src" runat="server" placeholder="code" CssClass="auto-style2" MaxLength="2" Width="125px"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr class="thStyle">
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtopv2" runat="server" onkeyup="input('txtopv2')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtopv2_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtopv2_src" runat="server" placeholder="code" CssClass="auto-style2" MaxLength="2" Width="125px"></asp:TextBox></td>
                            </tr>
                            <tr class="thStyle">
                                <td colspan="1" class="auto-style3">Penta2 (Right thigh)</td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtp2" runat="server" onkeyup="input('txtp2')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtp2_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtp2_src" runat="server" placeholder="code" CssClass="auto-style2" MaxLength="2" Width="125px"></asp:TextBox></td>
                            </tr>
                            <tr class="thStyle">
                                <td colspan="1" class="auto-style3">PCV2 (Left thigh)</td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtpcv2" runat="server" onkeyup="input('txtpcv2')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtpcv2_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtpcv2_src" runat="server" placeholder="code" CssClass="auto-style2" MaxLength="2" Width="125px"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr class="thStyle">
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtopv3" runat="server" onkeyup="input('txtopv3')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtopv3_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtopv3_src" runat="server" placeholder="code" CssClass="auto-style2" MaxLength="2" Width="125px"></asp:TextBox></td>
                            </tr>
                            <tr class="thStyle">
                                <td colspan="1" class="auto-style3">Penta3 (Right thigh)</td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtp3" runat="server" onkeyup="input('txtp3')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtp3_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtp3_src" runat="server" placeholder="code" CssClass="auto-style2" MaxLength="2" Width="125px"></asp:TextBox></td>
                            </tr>
                            <tr class="thStyle">
                                <td colspan="1" class="auto-style3">PCV3 (Left thigh)</td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtpcv3" runat="server" onkeyup="input('txtpcv3')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtpcv3_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtpcv3_src" runat="server" placeholder="code" CssClass="auto-style2" MaxLength="2" Width="125px"></asp:TextBox></td>
                            </tr>
                            <tr class="thStyle">
                                <td colspan="1" class="auto-style3">IPV (Left thigh)</td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtipv" runat="server" onkeyup="input('txtipv')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtipv_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtipv_src" runat="server" placeholder="code" CssClass="auto-style2" MaxLength="2" Width="125px"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr class="thStyle">
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtm1" runat="server" onkeyup="input('txtm1')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtm1_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtm1_src" runat="server" placeholder="code" CssClass="auto-style2" MaxLength="2" Width="125px"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr class="thStyle">
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtm2" runat="server" onkeyup="input('txtm2')" ClientIDMode="Static" placeholder="1 / 2" CssClass="auto-style2" MaxLength="1" Width="125px"></asp:TextBox></td>
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtm2_dt" runat="server" placeholder="dd/mm/yyyy" CssClass="auto-style2" MaxLength="10" Width="150px"></asp:TextBox>
                                ...
                                <td colspan="1" class="tdStyle tdText">
                                    <asp:TextBox ID="txtm2_src" runat="server" placeholder="code" CssClass="auto-style2" MaxLength="2" Width="125px"></asp:TextBox></td>
                            </tr>
                ...
                <table id="endtable" class="table table-hover table-reponsive" style="text-align: left; width: 100%; margin-top: 0px; font-size: 16px; background-color: #DDDDDD; font-family: Tahoma;">
                    ...
                    <tr class="thStyle">
                        ...
                        <td colspan="3" class="tdStyle tdText">
                            <asp:TextBox ID="txtQC" runat="server" placeholder="code" CssClass="auto-style2" required="required" MaxLength="4" Width="140px"></asp:TextBox></td>
