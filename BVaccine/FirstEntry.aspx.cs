...
namespace BVaccine
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        public void SubmitData()
        {
            ...
            try
            {
                string insertSt = "INSERT INTO VaccineData(dssid,study_id,bla01_nm,bla01_cd,bla02_dt,bla02_tm,bla03_dt,bla03_tm,bla04,bla05,bla06_dt,bla06_age,bla07,bla08,bla09,bla09x,bla10,bla11,bla12,bla13,bla14,bla14x,blb01,blb02,blb02x," +
                ...
                cmd.Parameters.AddWithValue("@dssid", txtDSSID.Text.ToUpper());
                cmd.Parameters.AddWithValue("@study_id", abc);
                cmd.Parameters.AddWithValue("@bla01_nm", txtName.Text.ToUpper());
                cmd.Parameters.AddWithValue("@bla01_cd", txtICode.Text.ToUpper());
                ...
                cmd.Parameters.AddWithValue("@blb09", txtQC.Text.ToUpper());
